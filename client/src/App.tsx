...
import WhatIsBiathlon from "./components/About/WhatIsBiathlon";
        ...
        <Router>
          ...
          <div className="content">
            <Switch>
              ...
              />
              <Route
                path="/About/Whatisbiathlon"
                exact
                component={() => <WhatIsBiathlon />}
              />
              <Route path="/About/More" exact component={() => <More />} />

              <Route
                path="/Competitions/Worldcup"
                exact
                component={() => <Worldcup2 />}
              />
              <Route
                path="/Competitions/Ibucup"
                exact
                component={() => <Ibucup2 />}
              />
              <Route
                path="/Competitions/Juniorcup"
                exact
                component={() => <Juniorcup2 />}
              />
              <Route
                path="/Competitions/Nationals"
                exact
                component={() => <Nationals2 />}
              />
              <Route
                path="/Competitions/Summerbiathlon"
                exact
                component={() => <Summerbiathlon2 />}
              />

              <Route
                path="/Results/Worldcup"
                exact
                component={() => <Worldcup />}
              />
              <Route
              ...
              />
              <Route
                path="/Results/Juniorcup"
                exact
                component={() => <Juniorcup />}
              />
              <Route
                path="/Results/Nationals"
                exact
                component={() => <Nationals />}
              />
              <Route
                path="/Results/Summerbiathlon"
                exact
                component={() => <Summerbiathlon />}
              />
