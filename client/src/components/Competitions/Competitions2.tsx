      ...
      <div className="middle">
        <div className="navbar">
          <ul className="navbar-nav ml-auto">
            <li
              className={`nav-item  ${
                props.location.pathname === "/Competitions/Worldcup"
                  ? "active"
                  : ""
              }`}
            >
            ...
            <li
              className={`nav-item  ${
                props.location.pathname === "/Competitions/Ibucup"
                  ? "active"
                  : ""
              }`}
            >
            ...
            <li
              className={`nav-item  ${
                props.location.pathname === "/Competitons/Juniorcup"
                  ? "active"
                  : ""
              }`}
            >
            ...
            <li
              className={`nav-item  ${
                props.location.pathname === "/Competitions/Nationals"
                  ? "active"
                  : ""
              }`}
            >
            ...
            <li
              className={`nav-item  ${
                props.location.pathname === "/Competitions/Summerbiathlon"
                  ? "active"
                  : ""
              }`}
            >
