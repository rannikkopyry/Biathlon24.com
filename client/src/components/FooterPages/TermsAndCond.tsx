    ...
    <>
      <div className="termsandcond">
        <div className="heading">
          <h1>Terms and conditions, Biathlon24.com</h1>
        </div>
        <div className="text">
          <h2>1. Terms</h2>
          <p>
          ...
          <p>
            ...
            you violate any of these restrictions and may be terminated by Awad
            Development, LLC at any time. Upon terminating your viewing of these
          ...
          <p>
            ...
            accordance with the laws of Texas and you irrevocably submit to the
